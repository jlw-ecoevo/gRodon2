...
`gRodon` has a number of dependencies - including the `Biostrings` and `coRdon`
...
##### A Tiny Detour: Annotating Your Genome
...
the blastdb included in [growthpred](http://ftp.pasteur.fr/pub/gensoft/projects/growthpred/)).
