...
For bulk estimation from metagenomes (see [Viera-Silva et al.](https://doi.org/10.1371/journal.pgen.1000808) for discussion), 
...
but not quite how slowly (doubling times >5hrs tend to be underestimates). 
