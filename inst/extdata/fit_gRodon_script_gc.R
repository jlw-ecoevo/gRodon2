...
## JLW 2021 - Fit GC-corrected metagenome mode
...
# cu <- getStatisticsBatch("~/gRodon2/inst/extdata/madin_genomes/")
cu <- gRodon:::getStatisticsBatch("~/gRodon/inst/extdata/madin_genomes/",
                                  mc.cores = 6)
setwd("~/gRodon/inst/extdata/")
save(cu, file = "CodonStatistics_GC.rda")
...
gRodon_model_newmeta <- model_list[[1]]
gRodon_model_newmeta_temp <- model_list[[2]]
gRodon_model_newmeta_nogc <- model_list[[3]]
gRodon_model_newmeta_nogc_temp <- model_list[[4]]
lambda_newmeta <- model_list[[5]]
